...
\section{Deep Q-Networks}
	...
	\begin{frame}
			\frametitle{Reward}
				The reward for a given action is measured by the change in ROUGE-NF1 score of the predicted summary $\tilde{y}_{t}$ measured against a gold standard summary $Y$. More formally, the reward $r$ at time $t$ is 
				\begin{equation}
