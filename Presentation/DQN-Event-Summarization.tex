...
\begin{frame}
	...
	\item<2-> Given the seemingly countless number of news and media outlets, manually reading and summarizing all of this content is impossible. 
		...
		\begin{frame}
			...
			\begin{center}
				\begin{itemize}
					...
					\item<2-> Optimizing F1 requires longer training
				\end{itemize}
			\end{center}
		\end{frame}
