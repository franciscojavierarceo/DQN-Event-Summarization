...
\begin{frame}
	...
	\item<1-> An extractive summarization algorithm sequentially examines sentences from a document stream and includes the candidate sentence into the summary when novel and important information is detected. 
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item<1-> These systems how been shown to  fall short of simple heuristic algorithms \cite{garbacea2015university}, which may be due to the limited ability of traditional n-gram models to capture the rich and often idiosyncratic structure of language.
	\end{itemize}
...
This leads us to explore Deep Q-Networks (DQN) for 3 reasons: 
	...
	\item <1 -> RNN-LSTM embeddings can learn a more robust semantic representation than classic n-gram models
	\end{enumerate}
\end{frame}
