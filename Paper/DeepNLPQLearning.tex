...
Previous work in this area has either incremented the system time in fixed increments (e.g., an hour)  \cite{mccreadie2014incremental,kedzie2015xpredicting} or operated in a fully online setting \cite{guo2013updating,kedzie2016real}. In both cases explicitly modeling the current state of the summary, the stream, and their relationship with the query is quite complicated and exhibits non-linear dynamics that are difficult characterize in traditional feature based models.
...
\begin{tikzpicture}[scale=0.75, transform shape]
        ...
        \path (wa.east)+(6.5,  0) node (output) [om] {\textbf{ReLU} \\ \scriptsize E[Rouge]} ;
...
\begin{tabular}{  c | c | c | c  }
	...
	\hline
	\multicolumn{4}{c}{Table 1. \footnotesize Extracted summary performance on manually reviewed nuggets} \\
	\hline
\end{tabular}
\end{center}
