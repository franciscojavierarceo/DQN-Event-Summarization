...
We process our queries and extract the 
...
We evaluate our learned extracted summaries on ROUGE-N F1, Recall, and Precision on the full set of nuggets. 
...
\begin{tabular}{  c | c | c | c  }
	...
	Random  & TBD & TBD \\ \hline
	\hline
	\multicolumn{4}{c}{Figure 1. Extracted summary performance on manually reviewed nuggets} \\
	\hline
\end{tabular}
\end{center}
