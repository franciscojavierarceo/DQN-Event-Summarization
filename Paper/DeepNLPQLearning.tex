...
\pgfsetlayers{background,main,foreground}
    ...
    \begin{tikzpicture}
        ...
        \path (wa.east)+(6.5,  0) node (output) [om] {\textbf{Max} \\ \scriptsize E[Rouge]} ;
     ...
     \begin{pgfonlayer}{background}[transparency group,opacity=.5]
        ...
        \path (wa.west) + (5.8,    1.95)  node (vote.east) {\scriptsize $\{argmax(\theta)$\}}; %{\textbf{Summary-Action Representation} };
