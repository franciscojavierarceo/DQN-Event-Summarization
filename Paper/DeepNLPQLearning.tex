...
\item The \cite{kedzie2016real} paper used a time penalty, need to find out which one
\item I think we can test a variety of different penalty metrics with respect to time
	\begin{itemize}
		...
		\item Maybe do a mixture of exponential decay and L1 to do the thresholding
		\item It'll be a neat exercise to modify l1 regularization to do this
	\end{itemize}
