...
\begin{tabular}{  c | c | c | c  }
	...
	DQN-LSTM  & \color{ red} TBD & \color{ red} TBD  & \color{ red} TBD\\
	DQN-BOW  & \color{ red}TBD & \color{ red} TBD  & \color{ red} TBD\\
	DQN-BiBOW  & \color{ red} TBD & \color{ red} TBD  & \color{ red}TBD\\
	Random  & \color{ red}TBD & \color{ red}TBD  & \color{ red}TBD\\ \hline
	\hline
