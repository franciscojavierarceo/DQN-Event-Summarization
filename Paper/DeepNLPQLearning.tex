...
We have open sourced our work on \href{https://github.com/franciscojavierarceo/DQN-Event-Summarization}{Github}. The repository contains 3 main folders: (1) Paper, (2) Presentation, and (3) Code. The Code folder contains 3 subfolders which consist of (1) Performance, (2) Simulations, and (3) Utils. Additionally, the three main files required to run n-fold cross validation on the 
